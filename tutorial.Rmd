...
**Segment usage**, the frequency of clonotypes having a specific Variable segment. These frequency profiles contain information about the VDJ rearrangement profile and CDR3-independent selection. Variable segments are known to interact with MHC molecule itself, as well as with the presented peptides via CDR1/2. 
